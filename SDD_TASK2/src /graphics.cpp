...
void Graphics::drawVarText(TTF_Font *font, int identifier, std::string msg, SDL_Color color, double sizeCoef, int x, int y){
    if(this->_labelTextureState[identifier] != msg || !this->_labelTextureState.count(identifier)){
...
void Graphics::drawStaticText(TTF_Font *font, int identifier, std::string msg, SDL_Color color, double sizeCoef, int x, int y){
    if(this->_labelTextureContent.count(identifier) == 0){
...
void Graphics::setRenderDrawColor(int r, int g, int b, int alpha){
    SDL_SetRenderDrawColor(this->_renderer, r, g, b, alpha);
